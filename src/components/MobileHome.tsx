      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0A0A0A]/95 backdrop-blur-md border-t border-gray-800/60 pb-safe z-50">
        <div className="flex justify-around items-center px-2 py-2.5">
          {[
            ...
            { label: "Branches", icon: MapPin, active: false },
            { label: "Contact", icon: User, active: false }
          ].map((item, i) => (
            <div key={i} className={`flex flex-col items-center gap-0.5 cursor-pointer w-14 transition-colors ${item.active ? "text-sasi-red" : "text-gray-600 hover:text-gray-400"}`}>
